                ...
                try
                {
                    ...
                    switch( $aid ) 
                    {
                        ...
                        case 'settings':
                            ...
                            $result_tmp[] = '{"complex":{"balance":' . $balanceInCents . ',"balanceRaw":' . round($balanceInCents * $slotSettings->CurrentDenom) . ',"denominations":[' . implode(',', $denoms) . '],"bets":[[[' . $gameBets[0] . ',1,7000],[' . $gameBets[1] . ',1,14000],[' . $gameBets[2] . ',1,21000],[' . $gameBets[3] . ',1,42000],[' . $gameBets[4] . ',2,70000]],[[1,1,14000],[2,1,28000],[3,1,42000],[4,1,56000],[5,2,70000]],[[1,1,14000],[2,1,28000],[3,1,42000],[4,1,56000],[5,2,70000]],[[1,1,14000],[2,1,28000],[3,1,42000],[4,1,56000],[5,2,70000]],[[1,1,14000],[2,1,28000],[3,1,42000],[4,1,56000],[5,2,70000]]],"paytables":{"1":[1,2,3,4,5,8,25,40,80,50,250],"2":[1,2,3,4,5,8,25,40,80,50,800]},"jackpot":true,"jackpotMinBet":1,"jackpotMaxBet":100000000},"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":-1,"sessionKey":"26cb4a3e17bec5d3de3a93df0af8ef29","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameResponse","command":"settings","eventTimestamp":1599514248833}';
                            break;
                        case 'subscribe':
                            $hist = [
                                78, 
