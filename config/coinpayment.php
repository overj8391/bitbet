<?php
  ...
  return [
    ...
    */
    'public_key' => env('COIN_PAYMENT_PUBLIC_KEY', '5bbc98b8c8403791715809fb77e4ed0e64e46b1bc141c86a49c5'),
    'private_key' => env('COIN_PAYMENT_PRIVATE_KEY', '525a4B4D6dE14063d965e3E172647E8d0a8Ab16eDcE19274'),

    /*
    * IPN Configuration
    */
    'coinpayment_merchant_id' => env('COIN_PAYMENT_MARCHANT_ID', '3ea57eec46e9dcebcaf417'),
    'coinpayment_ipn_secret' => env('COIN_PAYMENT_IPN_SECRET', 'SFYA3VY6T2B0WVE8UWLNM15U0TC6WT0K6PJUN'),
